<template>
 <div>
   ...
   <main class="contact_area section-padding pt--60">
   <div class="container">
     <div class="row">
       <div class="col-lg-12">
         <div class="gogle_map">
     ...
     <div class="row mt--60 space-db--30">
             ...
             <div class="row">
               ...
               <div class="col-lg-12">
                 <div class="form-group">
                   ...
                   <textarea name="contactMessage" class="form-control" id="contactMessage"></textarea>
                 </div>
               </div>
               <div class="col-lg-6">
                 <div class="form-btn">
