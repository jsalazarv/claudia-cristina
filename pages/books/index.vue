          ...
          <div class="col-lg-4 col-sm-6 mb--30">
            <div class="product-card">
              <div class="image">
                ...
                <div class="hover-content">
                  ...
                  <div class="hover-btns">
                    ...
                    <a href="javascript:" class="sin-btn" data-toggle="modal" data-target="#quickModal"><i class="ion-android-open"></i></a>
                  </div>
              ...
              <div class="description-block">
                ...
                <h3 class="post-title"> <a href="product-details.html"> zyfg men sweatshirts casual ethnic style pattern</a></h3>
              ...
              <div class="description-block list-description">
                ...
                <div class="price"><del class="price-old">€500.00</del> <span class="price-new">€500.00</span></div>
                  ...
                  <div class="col-lg-7 mt--30 mt-lg--30">
                    <div class="product-details-description pl-lg--30">
                      ...
                      <div class="price-block">
                        <del class="price-old">$500.00</del> <span class="price-new">$500.00</span>
                      </div>
